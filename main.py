...
# Fix SSL Certificate issues on Android
...
def main(page: ft.Page):
    try:
        ...
        page.add(
            ft.Container(
                content=ft.Column([
                    ft.Text("App Crashed!", size=24, color=ft.colors.RED_400, weight=ft.FontWeight.BOLD),
                    ft.Text(f"Error: {str(e)}", color=ft.colors.WHITE),
                    ft.Text(traceback.format_exc(), color=ft.colors.WHITE70, size=10, selectable=True)
